...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_sort" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a557ee5d#;
   pragma Export (C, u00001, "sortB");
   ...
   u00115 : constant Version_32 := 16#39d0dd9d#;
