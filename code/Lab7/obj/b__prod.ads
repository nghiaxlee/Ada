...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_prod" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a69eeae0#;
   pragma Export (C, u00001, "prodB");
   ...
   u00114 : constant Version_32 := 16#5dc07a5a#;
