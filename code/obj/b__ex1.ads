...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ex1" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#aa9b9bed#;
   pragma Export (C, u00001, "ex1B");
   ...
   u00133 : constant Version_32 := 16#5dc07a5a#;
   pragma Export (C, u00133, "system__memoryB");
   u00134 : constant Version_32 := 16#6bdde70c#;
